			...
			case "1.2.840.113549.1.7.1":
				{
					...
					// if((this.authSafe.content instanceof asn1js.OctetString) === false) // Felipe Lopes: Esse if não funciona e eu não sei o motivo!
					if (this.authSafe.content.constructor.name !== 'OctetString')
